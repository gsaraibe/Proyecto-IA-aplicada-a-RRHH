...
import {
  ...
  LogOut, Sparkles, X, BrainCircuit, ClipboardList,
} from 'lucide-react';
...
const AI_NAV_ITEMS = [
  { href: '/hr-intelligence', label: 'Análisis de CVs', icon: BrainCircuit },
  { href: '/hr-tests',        label: 'Pruebas de HR',   icon: ClipboardList },
];
